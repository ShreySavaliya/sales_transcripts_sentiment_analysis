...
def extract_conversations(file_content):
    """Extract the conversations of sales_agent and customer individually"""
...
def extract_customer_timestamps(file_content):
    """Extracting the timestamps for the customer from their conversations"""
...
def extract_sales_agent_timestamps(file_content):
    """Extracting the timestamps for the sales_agent from their conversations"""
...
def extract_customer_dialogues(file_content):
    """Extracting each dialogues of customer from their conversations"""
...
def extract_sales_agent_dialogues(file_content):
    """Extracting each dialogues of sales_agent from their conversations"""
